...
CREATE TABLE `mq_post`  (
  ...
  `is_publish` tinyint(1) NOT NULL DEFAULT 2 COMMENT '是否发布 1：发布 0：未发布（草稿）',
...
CREATE TABLE `mq_user`  (
  ...
  `salt` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '密码加盐',
